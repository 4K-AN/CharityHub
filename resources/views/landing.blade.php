    ...
    <section class="w-full bg-surface-container-low/40 py-section-gap px-margin-mobile md:px-margin-desktop">
        <div class="max-w-container-max-width mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                ] as [$initials, $name, $role, $quote, $gradient])
                <div class="bg-surface-container-lowest rounded-2xl border border-outline-variant/15 p-6 shadow-soft card-hover reveal">
                    <div class="flex items-center gap-3.5 mb-5">
                        <div class="w-11 h-11 rounded-xl bg-gradient-to-br {{ $gradient }} text-white flex items-center justify-center font-bold text-sm shadow-sm">{{ $initials }}</div>
                        <div>
                            <p class="text-title-md text-on-surface font-bold">{{ $name }}</p>
                            <p class="text-label-sm text-on-surface-variant">{{ $role }}</p>
                        </div>
                    </div>
                    <p class="text-body-md text-on-surface-variant mb-5 leading-relaxed italic">{{ $quote }}</p>
    ...
    <section class="w-full py-section-gap px-margin-mobile md:px-margin-desktop">
        <div class="max-w-container-max-width mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                ] as [$icon, $title, $desc, $bgGrad, $textColor])
                <div class="text-center p-6 rounded-2xl bg-surface-container-lowest border border-outline-variant/10 shadow-soft card-hover reveal">
                    <div class="w-14 h-14 rounded-2xl bg-gradient-to-br {{ $bgGrad }} flex items-center justify-center mx-auto mb-4">
                        <span class="material-symbols-outlined text-[28px] {{ $textColor }}">{{ $icon }}</span>
                    </div>
                    <h3 class="text-title-lg text-on-surface mb-2 font-bold">{{ $title }}</h3>
                    <p class="text-body-sm text-on-surface-variant leading-relaxed">{{ $desc }}</p>
                </div>
                @endforeach
            </div>
        </div>
