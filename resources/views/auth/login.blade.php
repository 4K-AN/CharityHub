    ...
    <div class="bg-surface-container-lowest rounded-2xl shadow-lg border border-outline-variant/30 p-8 md:p-10">
        ...
        <div class="text-center mb-8">
            <div class="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <span class="material-symbols-outlined text-[32px] text-primary">login</span>
            </div>
            <h1 class="text-[28px] font-bold text-on-surface mb-2">Selamat Datang</h1>
            <p class="text-[16px] text-on-surface-variant">Masuk ke akun CharityHub Anda</p>
        </div>
        ...
        <div class="mt-6 text-center">
            <p class="text-[14px] text-on-surface-variant">
                Belum punya akun?
                <a href="/register" class="text-primary font-semibold hover:underline">Daftar sekarang</a>
            </p>
        </div>
    </div>

    <!-- Demo Credentials -->
    <div class="mt-6 bg-surface-container rounded-xl p-4 border border-outline-variant/30">
        <p class="text-[12px] font-semibold text-outline mb-2 text-center">🔑 Demo Credentials</p>
        <div class="grid grid-cols-2 gap-3 text-[12px]">
            <button onclick="fillCredentials('rina@charityhub.test','password123')" class="p-2 rounded-lg bg-surface hover:bg-primary/5 border border-outline-variant/30 text-left transition-colors">
                <p class="font-semibold text-on-surface">Campaigner</p>
                <p class="text-outline">rina@charityhub.test</p>
            </button>
            <button onclick="fillCredentials('andi@charityhub.test','password123')" class="p-2 rounded-lg bg-surface hover:bg-primary/5 border border-outline-variant/30 text-left transition-colors">
                <p class="font-semibold text-on-surface">Donatur</p>
                <p class="text-outline">andi@charityhub.test</p>
            </button>
        </div>
    </div>
</div>
